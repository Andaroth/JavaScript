    ...
    */
    if (guess == motMystere) { // Si le joueur entre direct le mot recherché
        ...
        */
        for (i=0;i<motLong;i++) { 
            ...
            if (guess == soluce[i]) // Si la saisie == la lettre ciblée par l'index i dans le tableau soluce
            {
                ...
                promptMot = found.join(); // On actualise l'aperçu du mot dans le prompt
        ...
        */
        ...
        else { // Sinon félicitations, bravo, congratulations ! Les esclaves peuvent arrêter de tourner, le jeu est terminé tu as gagné !
